<script setup>
import FooterSmMain from './footer-sm/FooterSmMain.vue'
import FooterRightsMain from './footer-rights/FooterRightsMain.vue'
...
@media (min-width: 320px) {
  .footer-container {
    @include flex-columns-items-center(3em);
